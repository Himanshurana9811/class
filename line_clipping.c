...
"); 
scanf("%f %f", &xmin, &ymin); // 100 100 
printf("\n\t Please enter the top right co-ordinate of viewport: ");
scanf("%f %f", &xmax, &ymax);//400 400
printf("\n\t Please enter the co-ordinates for starting point of 
line: ");
scanf("%f %f", &x1, &y1);//120 60
printf("\n\t Please enter the co-ordinates for ending point of line: 
");
scanf("%f %f", &x2, &y2);// 350 450
for (i = 0; i < 4; i++){
start[i] = 0;
end[i] = 0;
}
...
if ((code[0] == 0) && (code[1] == 0) && (code[2] == 0) && (code[3] 
== 0))
{
if ((start[0] == 0) && (start[1] == 0) && (start[2] == 0) && 
(start[3] == 0) && (end[0] == 0) && (end[1] == 0) && (end[2] == 0) && 
(end[3] == 0))
{
cleardevice();
